#!/usr/bin/env tsx
// WORKING Mobile Products Seeding Script - FIXED TYPES
// Uses the current database structure with correct TypeScript types
...
async function main() {
  ...
  try {
    ...
    // Create Products with correct enum types
    ...
    for (const product of createdProducts) {
      ...
      for (let i = 0; i < quantity; i++) {
        ...
        const inventoryData = product.type === 'MOBILE_PHONE' 
          ? { 
              ...baseInventoryData,
