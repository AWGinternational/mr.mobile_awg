  ...
  return (
    <ProtectedRoute allowedRoles={[UserRole.SHOP_OWNER, UserRole.SUPER_ADMIN]}>
                ...
                <div className="flex flex-col gap-4 sm:gap-0 sm:flex-row sm:justify-between sm:items-center">
                  <div className="flex items-center gap-3 sm:gap-4">
                    ...
                    <div className="min-w-0">
                      <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-1 sm:mb-2 truncate">👥 Worker Management</h1>
                  ...
                  <div className="flex items-center gap-3 sm:gap-4">
                    {canAddMoreWorkers && (
                      <Button
                        ...
                        className="bg-white text-indigo-600 hover:bg-gray-100 text-sm sm:text-base"
                      >
                        <UserPlus className="h-4 w-4 mr-2" />
                        Add Worker
                      </Button>
                    )}
                    <Shield className="h-12 w-12 sm:h-16 sm:w-16 text-white/20 hidden sm:block" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
              {loading ? (
                <div className="text-center py-12">
                  ...
                  <p className="mt-4 text-sm sm:text-base text-gray-600 dark:text-gray-400">Loading workers...</p>
                </div>
              ) : workers.length === 0 ? (
                <Card className="bg-white dark:bg-gray-800 dark:border-gray-700">
                  <CardContent className="p-8 sm:p-12 text-center">
                    <Users className="h-12 w-12 sm:h-16 sm:w-16 text-gray-400 dark:text-gray-600 mx-auto mb-4" />
                    <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white mb-2">No Workers Yet</h3>
                    <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">Add workers to your shop to manage their permissions.</p>
                  </CardContent>
                </Card>
              ) : (
                    ...
                    <Card key={worker.id} className="hover:shadow-lg dark:hover:shadow-gray-900/50 transition-shadow bg-white dark:bg-gray-800 dark:border-gray-700">
                      <CardHeader className="p-4 sm:p-6">
                        <div className="flex justify-between items-start gap-2">
                          <div className="min-w-0 flex-1">
                            <CardTitle className="text-base sm:text-lg dark:text-white truncate">{worker.name}</CardTitle>
                            <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mt-1 truncate">{worker.email}</p>
                          </div>
                          {worker.isActive ? (
                      ...
                      <CardContent className="p-4 sm:p-6 pt-0">
                        <div className="space-y-2 sm:space-y-3">
                          {worker.phone && (
                            <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">📱 {worker.phone}</p>
                          )}
                          ...
                          <div className="flex gap-2 mt-3 sm:mt-4">
                            <Button
                              ...
                              className="flex-1 flex items-center justify-center gap-2 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700 text-xs sm:text-sm"
                              variant="outline"
                              size="sm"
      ...
      <Dialog open={addWorkerDialogOpen} onOpenChange={setAddWorkerDialogOpen}>
        <DialogContent className="sm:max-w-[500px] bg-white dark:bg-gray-800 dark:border-gray-700">
          <DialogHeader>
          ...
          <div className="space-y-4 mt-4">
            <div>
              <Label htmlFor="worker-name" className="dark:text-gray-300">
            ...
            <div>
              <Label htmlFor="worker-email" className="dark:text-gray-300">
            ...
            <div>
              <Label htmlFor="worker-phone" className="dark:text-gray-300">
            ...
            <div>
              <Label htmlFor="worker-password" className="dark:text-gray-300">
          ...
          <div className="flex gap-3 justify-end mt-6 pt-4 border-t dark:border-gray-700">
            <Button 
              variant="outline" 
              onClick={() => {
                setAddWorkerDialogOpen(false)
      ...
      <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
        <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto bg-white dark:bg-gray-800 dark:border-gray-700">
          <DialogHeader>
          ...
          <div className="space-y-6 mt-4">
            {modulePermissions.map((module, index) => (
              <Card key={`${module.module}-${index}`} className="bg-white dark:bg-gray-900 dark:border-gray-700">
                <CardHeader>
                  <CardTitle className="text-lg dark:text-white">{module.displayName}</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                    {Object.entries(module.permissions).map(([permission, enabled]) => (
                      <div key={`${module.module}-${permission}`} className="flex items-center space-x-2">
                        <Switch
